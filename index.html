...
<head>
    <title>Richard Diocares P.- Multimedia Profile</title>

</head>

<body>
    <h1>Richard diocares P.</h1>
    <h2>Personal Information</h2>
    <p>
        <br>My name is Richard Diocares P.
        I am a Grade 11 ICT student.<br>
        My birthday is on Feb 19.
    </p>
    <img src="">
    <p>
    ...
    <p>
        ...
        Hi! My name is Richard Diocares P. I am a Grade 11 ICT student who is passionate about technology and programming. I enjoy learning new coding skills and improving my knowledge of web development. My goal is to become a successful software developer in the future.
    </p>
    ...
    <ol type="A">
        <li>Adobo</li><li>Lechon</li><li>Chicken</li><li>Ice cream</li><li>French fries</li>
    </ol>
